class SupportTicketResPartner{
  ...
  static SupportTicketResPartner fromJson(Map<String, dynamic> json) => SupportTicketResPartner(
    ...
    partner_id: json['partner_id'] == false || json['partner_id'] == null  ? json['partner_id'] = 'false' : json['partner_id'][0].toString(),
    partner_name: json['partner_id'] == false || json['partner_id'] == null ? json['partner_id'] = 'false' : json['partner_id'][1].toString(),    
